                  ...
                  <CardContent className="space-y-4">
                    <div>
                      <div className="text-xs text-muted-foreground space-y-2">
                        ...
                        <p>
                          Prime factor distribution reveals the following
                          pattern:
                        </p>
                        <p>2s are significantly more prevalent than 5s.</p>
                        <p>
                          Every second number is even and contributes to a
                          factor of 2, where-as only numbers divisible by 5
                          provide a factor of 5.
                        </p>
                        <p>
